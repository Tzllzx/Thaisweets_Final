...
// ถ้าไม่พบสินค้าให้กลับไปหน้าสินค้าทั้งหมด
if (!$product) {
...
<head>
    ...
    <style>
        ...
        .cart-badge {
            ...
            background: #ff3b3b; color: white; font-size: 11px;
        ...
        .qty-input button {
            ...
            cursor: pointer; color: var(--dark); width: 30px;
        }
        .qty-input input {
            width: 50px; text-align: center; border: none;
            background: none; font-size: 1.2rem; font-weight: bold;
        }
        ...
        .btn-add-cart:hover {
            ...
            box-shadow: 0 10px 20px rgba(169, 106, 45, 0.3);
        }
        .btn-back {
            flex: 1;
            padding: 18px;
...
<div class="container">
    <div class="product-wrapper">
        <div class="product-image">
            <?php $image_path = !empty($product['image']) ? "assets/images/" . $product['image'] : "assets/images/no-image.png"; ?>
        ...
        <div class="product-info">
            ...
            <div class="description">
                <?= nl2br(htmlspecialchars($product['description'] ?? 'ขนมไทยต้นตำรับ รสชาติกลมกล่อม หอมหวานกำลังดี ทำสดใหม่ทุกวันจากวัตถุดิบธรรมชาติที่เราคัดสรรมาอย่างดี เพื่อส่งต่อความอร่อยแบบดั้งเดิมให้คุณ')) ?>
            </div>
            ...
            <div class="action-btns">
                ...
                <a href="products.php" class="btn-back">ย้อนกลับ</a>
            </div>
        </div>
    </div>
</div>
...
<script>
// ฟังก์ชันเพิ่ม/ลดจำนวนในหน้าเว็บ
...
// ฟังก์ชันส่งค่าไปที่ add_to_cart.php ด้วย AJAX
function addToCart() {
    let id = <?= $product['id'] ?>;
